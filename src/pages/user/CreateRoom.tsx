...
import { sendEmailToCandidate } from "../../service/Api/meetApis";
          ...
          {!meetingUrl ? (
                  ...
                  <div className="w-full p-4 bg-gray-100 rounded-md space-y-2">
                    ...
                    {interviewDate && interviewTime && (
                      <div className="text-sm text-gray-600">
                        Interview scheduled for {interviewDate} at{" "}
                        {interviewTime}
                      </div>
                    )}
                  </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center bg-green-100 text-green-700 p-3 rounded-md">
                ...
                <span>
                  Meeting invite {emailSent ? "sent" : "queued"} to{" "}
                  {candidate?.email}
                </span>
              </div>
              ...
              <div className="text-center text-sm text-gray-600">
                The candidate will receive an email with the link to join this
                interview.
              </div>
            </div>
          )}
